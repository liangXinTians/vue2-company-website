      ...
      <div class="section-nav">
        ...
        <ul class="nav-list">
          <li
            ...
            :key="navItem.path"
            @click="handleClickNavItem(navItem)"
          >
            <div>{{ navItem.title }}</div>
            <ul class="nav-children" v-if="navItem.children && navItem.active">
              <li
                class="nav-child"
                :class="{ active: navChild.active }"
                v-for="(navChild, index) in navItem.children"
                :key="navChild.path"
                @click.stop="handleClickNavChild(navItem.children, index)"
              >
                {{ navChild.title }}
              </li>
            </ul>
          ...
          children: [
            {
              ...
              // 服务概述
              summary: [
                "渗透测试是完全模拟黑客可能使用的攻击技术和漏洞发现技术，对目标系统的安全做深入的探测，发现系统最脆弱的环节。渗透测试和黑客入侵最大区别在于渗透测试是经过客户授权，采用可控制、非破坏性质的方法和手段发现目标和网络设备中存在弱点，帮助管理者知道自己网络所面临的问题，同时提供安全加固意见帮助客户提升系统的安全性。服务采取远程/现场漏洞挖掘的方式进行服务",
              ],
              // 服务收益
              earnList: [
                {
            ...
            },
            {
              ...
              active: false,
              summary: [
                "服务采取“人”与“工具”结合的模式，所使用的安全漏洞扫描工具是国内外领先的扫描器，安全专家的介入有效提高漏洞结果准确率，以及降低扫描工具对评估环境的负担和风险。提供专业的漏洞修复报告并且配备专业的安全专家进行人工解读，确保漏洞能及时得到专业的修复指导。",
              ],
              earnList: [
                {
                  icon: "",
            ...
            },
            {
              ...
              active: false,
              summary: [
                "基线检查服务能够帮助客户IT人员，高效的检查设备、收集数据、制作和审核风险报告，识别各项不符合安全规范要求的系统。",
              ],
              earnList: [
                {
                  icon: "",
                  list: [
                    "服务可以覆盖客户上线安全检查、第三方入网安全检查、合规安全检查、日常安全检查等全方位检查",
                  ],
                },
                {
                  icon: "",
            ...
            },
            {
              ...
              active: false,
              summary: [
                "代码审计服务能够对整个信息系统的所有源代码进行检查，从整套代码切入最终明至某个威胁点并加以验证，以此明确整体系统中的安全隐患点。",
              ],
              earnList: [
                {
                  icon: "",
                  list: [
                    "源代码审计服务可有效督促管理人员杜绝任何一处小的缺陷，从而降低整体风险。",
                  ],
                },
                {
                  icon: "",
                  list: [
                    "通过专业的源代码审计报告，能为用户开发人员提供安全问题的解决方案，完善代码安全开发规范。",
                  ],
                },
              ],
            },
          ...
          children: [
            {
              ...
              active: false,
              summary: [
                "ISO27001是部针对信息技术、安全技术、信息安全管理体系(ISMS)的国际标准若重关注保持信息的密性、完整性、可用性，另外也可包括例如真实性、可核查性、不可否认性和可靠性等，获得1SO27001相关证书意味着组织基本符合了信息安全管理领域最佳行业实践，为企业提高市场竞争力，改进企业内部管理英定了基础。安盾信息结合以往的1SO27001认证实施经验，基于实施过程方法论，推出了IS027001认证咨询服务，来解决当前企业所面临的难题。",
              ],
              earnList: [],
            },
            {
              ...
              active: false,
              summary: [
                "风险评估服务由资产评估、威胁评估、脆弱性评估、风险分析、风险处置计划等部分组成；通过服务帮助客户了解网络与信息系统的安全状况，同时通过对发现的问题和风险进行综合分析，输出最优化的方案建议。",
              ],
              earnList: [],
            },
            {
              ...
              active: false,
              summary: [
                "依据国家相关法律法规，为用户提供一站式等级保护咨询服务，专业的咨询服务能在符合网络安全等级保护基础上，保障网络安全与信息化建设相协调，控制网络安全建设成本，优化网络安全资源的配置。",
              ],
              earnList: [
                {
                  icon: "",
                  list: [
                    "服务本身除了帮助用户快速获证之外，还聚焦服务过程帮助发现安全现状与安全要求的差距以及获得中长期的等级保护建设发展规划建议。",
                  ],
                },
              ],
            },
          ...
          children: [
            {
              ...
              active: false,
              summary: [
                "安盾信息所提供的安全技能培础课程，是为进一步加强网络安全人才培养，以网络安全培训作为网络安全人才技能提升的重要手段。通过技能培训，可以有效提升学员的技术、沟通、领导、协调等各方面能力。",
            ...
            },
            {
              ...
              active: false,
              summary: [
                "人的安全是企业安全的最后一道防线，信息安全意识淡薄是网络安全事件频发的关键因素。安盾信息多年企业安全意识教育经验，总结出一套安全意识培训框架，可以帮助提升企业信息安全意识文化。",
              ],
              earnList: [],
            },
          ],
