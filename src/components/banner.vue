<template>
  ...
  >
    <el-carousel-item v-for="item in list" :key="item.id">
      <div
        class="swiper-item-wrap flex flex-cross-center"
      ...
      >
        <div class="page-content">
          <div class="swiper-item">
            ...
            <router-link v-if="isHome" class="swiper-item-btn flex flex-center" :to="item.path"
              >查看详情</router-link
            >
          </div>
        </div>
      ...
      list: [
        {
          ...
          title: "安盾信息",
          desc: "安盾是一家领先的实战创新型网络安全公司，专业的网络安全综合解決方案提供商。公司秉承“安全左移、以攻促防”的安全理念，专注于开源治理、漏洞风险检测、安全防御建设和攻防型人オ培养，致力于帮助用户先于黑客发现并及时解决安全问题，共同打造个更安全、更便捷、更美好的互联网世界。",
        },
        {
          id: 2,
          path: "/devsecops",
